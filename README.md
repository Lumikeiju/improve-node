...
JOSM plugin for efficiently improving nodes.

## Usage

Usage instructions are identical to those of [ImproveWay](https://github.com/JOSM/improve-way), but for nodes without parent ways.
